...
def test_hktest_small_kk():
    ...
    assert_allclose(t.loc['A','DoF'], 2)
    assert_allclose(t.loc['B','DoF'], 2)
    assert_allclose(t.loc['Interaction','DoF'], 1)
    assert_allclose(t.loc['A','chi2'], 1.19391219,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['B','chi2'], 3.23483213,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['Interaction','chi2'], 1.47580575,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['A','p'], 0.55048471,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['B','p'], 0.19841072,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['Interaction','p'], 0.22443191,rtol=1e-4, atol=1e-4)
...
def test_hktest_large_kk():
    ...
    assert_allclose(t.loc['A','DoF'], 1)
    assert_allclose(t.loc['B','DoF'], 1)
    assert_allclose(t.loc['Interaction','DoF'], 1)
    assert_allclose(t.loc['Residual','DoF'], 8)

    assert_allclose(t.loc['A','SS'], 1.90311078,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['A','MS'], 1.90311078,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['A','F'], 31.67984670,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['A','p'], 0.00049360,rtol=1e-4, atol=1e-4)

    assert_allclose(t.loc['B','SS'], 2.43814058,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['B','MS'], 2.43814058,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['B','F'], 40.58613970,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['B','p'], 0.00021577,rtol=1e-4, atol=1e-4)

    assert_allclose(t.loc['Interaction','SS'], 0.73433912,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['Interaction','MS'], 0.73433912,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['Interaction','F'], 10.86215049,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['Interaction','p'], 0.01092744,rtol=1e-4, atol=1e-4)

    assert_allclose(t.loc['Residual','SS'], 0.54084253,rtol=1e-4, atol=1e-4)
    assert_allclose(t.loc['Residual','MS'], 0.06760532,rtol=1e-4, atol=1e-4)

    assert_allclose(t.loc['Total','SS'], 5.616433,rtol=1e-4, atol=1e-4)
