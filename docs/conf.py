# -*- coding: utf-8 -*-
#
# PyCircStat documentation build configuration file, created by
...
MOCK_MODULES = ['numpy', 'scipy', 'matplotlib', 'matplotlib.pyplot', 'decorator', 'pandas']
...
htmlhelp_basename = 'PyCircStatdoc'
